...
criterion, higher-order decorrelation (van der Corput), Elliott–Halberstam
chain, and energy increment dynamics.

CME reductions, fiber energy bounds, and hierarchy connectors have been
extracted to `CMEReduction.lean`.
