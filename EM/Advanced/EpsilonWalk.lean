...
/-- Under SRE + SigmaCRT, the death density converges to 1/(q-1).
...
/-- CRT equidist gives lethal visit density bounded below for each fixed step k.
    Under SRE + SigmaCRT, death density at step k tends to 1/(q-1) > 0. -/
