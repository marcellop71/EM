...
This file assembles the three target theorems of the FF unconditional series:

**Theorem A** (Factor Tree Density-1): Every monic irreducible appears on some
branch of the factor tree, for density-1 squarefree starting points.
...
| Master.lean | ~240 | 4 | Assembly of target theorems |
| **Total** | **~1685** | **78+** | |
-/
...
/-- Grand summary: everything proved in the FF unconditional series.
    ...
    Line count: ~1645 lines across 5 files (FactorTree, PopulationEquidist,
    StochasticMC, Finiteness, Master), zero sorry, zero errors.
