...
This file documents Dead End #127: Function Field Analog.
Category: TECHNIQUE MISMATCH. Maps to #90 (orbit specificity),
#108 (scale mismatch), #58/#117 (multiplier-to-walk transfer).
-/
