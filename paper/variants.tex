...
requires UFDStrong (spectral diversity of two-point factor sets).
Neither implies the other: DSL is about the \emph{selected} factor's
equidistribution; UFDStrong is about the \emph{pair}'s spectral gap.
