...
The full FF unconditional series totals ${\sim}1{,}673$ new lines
across five files (\code{FactorTree}, \code{PopulationEquidist},
...
assembles:
\[
  \underbrace{\text{Factor tree structure}}_{\text{Thm~\ref{thm:ff-factor-tree}}}
  \;+\;
...
The formalization across fourteen files (${\sim}6{,}300$~lines, zero
