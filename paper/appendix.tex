...
\lean{EM/FunctionFieldAnalog.lean}{FFMullinConjecture}
...
(\lean{EM/FunctionFieldAnalog.lean}{weil\_implies\_population\_equidist}):
...
\lean{EM/FunctionFieldAnalog.lean}{WeilDoesNotImplyFFDSL}),
...
(\lean{EM/FFBootstrap.lean}{ff\_element\_capture}):
...
(by \lean{EM/FFBootstrap.lean}{ffSeq\_injective\_proved}).
...
\begin{theorem}[\lean{EM/FFBootstrap.lean}{ff\_dh\_implies\_ffmc}]
...
\begin{theorem}[\lean{EM/FFSubgroupEscape.lean}{weil\_implies\_ff\_se}]
\label{thm:ff-se}
...
\lean{EM/FFSubgroupEscape.lean}{ff\_se\_degree\_one}).
...
\begin{example}[\lean{EM/CyclicWalkCoverage.lean}{alternating\_walk\_misses\_two}]
\label{ex:z4}
...
(\lean{EM/FFMultiplierCCSB.lean}{ff\_mc\_mult\_ccsb\_landscape}):
...
\lean{EM/FunctionFieldAnalog.lean}{ff\_cyclotomic\_dead\_end}]
...
\lean{EM/WeakMullin.lean}{WeakMullin}
...
\lean{EM/WeakMullin.lean}{ReciprocalDivergence}
The reciprocal sum over EM primes diverges:
$\sum_{k=0}^{\infty} 1/\seq{2}(k) = \infty$.
\end{property}

\begin{theorem}[\lean{EM/WeakMullin.lean}{mc\_implies\_wm}]
$\MC \Longrightarrow \mathrm{WM}$.
\end{theorem}

\begin{theorem}[\lean{EM/WeakMullin.lean}{wm\_implies\_rd}]
\label{thm:wm-rd}
...
\begin{theorem}[\lean{EM/WeakMullin.lean}{safe\_fraction\_exp\_bound}]
...
\begin{theorem}[\lean{EM/WeakMullin.lean}{not\_wm\_product\_diverges}]
...
\begin{theorem}[\lean{EM/WeakMullin.lean}{embv\_implies\_mc}]
...
\begin{theorem}[\lean{EM/WeakMullin.lean}{per\_prime\_confined\_energy\_lb}]
...
\begin{theorem}[\lean{EM/WeakErgodicity.lean}{prod\_squarefree}]
...
\begin{theorem}[\lean{EM/WeakErgodicity.lean}{pe\_transfer\_cme\_implies\_mc}]
