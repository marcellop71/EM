...
sieve theory;
Appendix~\ref{app:function-field} develops the function field analog
over~$\FF_p[t]$, where the Weil bound replaces Wiener--Ikehara and the
orbit-specificity barrier is isolated in pure form;
