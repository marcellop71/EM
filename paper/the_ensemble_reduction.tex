...
non-vanishing).  The one-sided Tauberian lemma and the
prime power stripping step are now machine-verified
(\code{OneSidedTauberian.lean}, 557~lines); the sole remaining
blocking dependency is the real-variable Wiener--Ikehara bridge
