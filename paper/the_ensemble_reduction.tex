...
$\varepsilon$, and the simultaneous-in-$q$ form is \textbf{open}, because
natural density is only finitely additive and the per-$q$ statements
therefore do not combine.  Finite subadditivity does give a uniform
...
theorem about countably additive measures.  The horizon $n = n(q,\varepsilon)$ is finite:
