...
(\lean{EM/Population/SelectionLaw.lean}{SurvivesUpTo}); phrasing it without
reference to the value of the multiplier is what removes the $q$-power
subtlety.  This is an exact identity, not an estimate: the roughness
