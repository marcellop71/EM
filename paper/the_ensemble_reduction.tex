...
An unconditional lower bound on $\mathbb{E}[1/\seq{\cdot}(1)]$ for $k \geq 1$
remains open---it requires knowing the density of $1$-mod-$6$
squarefree integers, which involves sieve asymptotics.
