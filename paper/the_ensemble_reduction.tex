...
--- and that is the strongest simultaneous form natural density supports:
the countable version would need a Borel--Cantelli argument, which is a
theorem about countably additive measures.  On an ensemble that carries
