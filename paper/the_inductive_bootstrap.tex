...
\begin{theorem}[\lean{EM/EquidistBootstrap.lean}{mcBelow\_pre\_implies\_se}]
\label{thm:bootstrap}
...
\begin{theorem}[\defname{One-prime gap} --- \lean{EM/EquidistThreshold.lean}{mcBelow\_cofinal\_hit\_implies\_mc\_at}]
