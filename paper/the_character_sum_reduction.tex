...
\]
which decomposes as
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{char\_sum\_energy\_eq\_N\_plus\_cross}]
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{cross\_term\_controls\_growth}]
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{total\_cross\_term\_eq\_sum\_fiber}]
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{feb\_implies\_cme}]
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{char\_value\_norm\_one}]
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{shifted\_walk\_eq\_mult\_mul\_cof}]
\label{thm:cofactor}
...
\begin{theorem}[\lean{EM/DSLInfrastructure.lean}{walkZ\_eq\_neg\_one\_iff\_cofZ\_zero}]
