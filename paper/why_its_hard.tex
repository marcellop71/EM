...
Over 121~potential approaches were explored and found to be dead ends,
grouped into five categories: ensemble-to-orbit transfer failures,
independence/linearity violations, wrong algebraic structure, reduction
to single-modulus CCSB, and the multiplier-to-walk transfer barrier.
The full catalogue is in Appendix~\ref{app:dead-ends}.

\paragraph{The Four-Way Blocker.}
The majority of the 121~dead ends reduce to a single meta-obstacle:
...
orbit?---remains open (\S\ref{sec:open}).
