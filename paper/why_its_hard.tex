...
sparse product contraction machinery (Part~19) gives vanishing averaged
products, and the Fourier counting argument (Part~14) yields
...
\end{theorem}
\noindent
This does \textbf{not} imply standard MC: the selection~$\sigma$ may
differ per prime~$q$, and the virtual accumulator
