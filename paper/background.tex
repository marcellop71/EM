...
human author and an AI system (Claude, Anthropic) across 120+~sessions.
...
\item A \emph{code stylist} that enforces Mathlib conventions.
\end{itemize}
...
The human author guided the proof effort across 120+~sessions, suggesting
