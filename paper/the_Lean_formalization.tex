...
The formalization uses Lean~4 with Mathlib~v4.27.0 across 43~files
totaling ${\sim}29{,}800$~lines.  The dependency chain is linear, with
three leaf modules:
...
\code{WeakErgodicity.lean} & Squarefree accumulator, shifted squarefree population, PE+PT (\S93--\S95) & 154 \\
