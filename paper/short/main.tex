...
polynomial has exactly $2^n$ points.  Over $\ZZ$ the corresponding
statement, that some Sylvester tower of Euclid numbers is all prime, is
what $\Cinf$ denies and what no method can exclude.
