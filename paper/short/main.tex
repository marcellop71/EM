...
profinite ensemble $\prod_{r\ \text{prime}}\ZZ/r\ZZ$ with the product uniform measure the
...
infrastructure (neither is in Mathlib as of \texttt{v4.33.0}).\footnote{Mertens' first theorem is not currently available
