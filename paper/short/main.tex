...
$\varepsilon$, and the simultaneous-in-$q$ form is open, since natural
density is only finitely additive: finite subadditivity does give one
horizon uniform over any \emph{finite} set of primes
(\lean{EM/Population/AlmostAllDensity.lean}{finite\_simultaneous\_density}),
and that is as far as it goes.  The horizon is finite; there is no
